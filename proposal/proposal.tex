...
%output produced by the original sequential code and the one produced by the
%parallel code.
%
...
%
%Evolutionary computing has also been applied to several other optimizations in compilers.
%Schulte~\etal~\cite{schulte14a} propose a post-compilation optimization
%approach that leverages ideas from evolutionary computation 
%in order to reduce energy consumption.
%The proposed approach is a steady-state evolutionary
